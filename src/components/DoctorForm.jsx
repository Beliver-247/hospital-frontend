  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="grid gap-4 bg-white border rounded-2xl p-6 max-w-lg">
      ...
      <div>
        ...
        <input className="mt-1 w-full rounded-md border px-3 py-2 focus:ring-2 ring-emerald-600"
               {...register('name')} />
      ...
      <div>
        ...
        <input type="email" className="mt-1 w-full rounded-md border px-3 py-2 focus:ring-2 ring-emerald-600"
               {...register('email')} />
      ...
      <div>
        ...
        <input type="password" className="mt-1 w-full rounded-md border px-3 py-2 focus:ring-2 ring-emerald-600"
               {...register('password')} />
      ...
      <div className="flex items-center gap-2">
        ...
        <p className="text-sm text-gray-600">An account will be created with STAFF-provided password.</p>
      </div>
    </form>
  );
}
